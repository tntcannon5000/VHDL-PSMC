...
HD_PWD='C:/Users/weirdchamp/Documents/Vivado Projects/FREQUENCY_CALC_TOP/FREQUENCY_CALC_TOP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FREQUENCY_CALCULATOR.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FREQUENCY_CALCULATOR.tcl
