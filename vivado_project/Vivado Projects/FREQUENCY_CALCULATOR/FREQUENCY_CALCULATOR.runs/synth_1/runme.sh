...
HD_PWD='C:/Users/weirdchamp/Documents/Vivado Projects/FREQUENCY_CALCULATOR/FREQUENCY_CALCULATOR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log REGI.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source REGI.tcl
